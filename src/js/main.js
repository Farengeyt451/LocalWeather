...
function hey(responce) {
	var date = new Date(responce.dt * 1000);
...
function getCityName(responce) {
	...
	$("#temp").text(Math.floor(responce.main.temp) + String.fromCharCode(176));
	$("#desc").text(responce.weather[0].main);
